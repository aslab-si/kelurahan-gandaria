            ...
            <div class="carousel-inner" role="listbox">
                ...
                <div class="carousel-item active" style="background-image: url(assets/img/slide/slide-1.jpg)">
                    <div class="carousel-container">
                        <div class="container">
                            <h2 class="animate__animated animate__fadeInDown">Website Kelurhan <span>Gandaria</span>
                            </h2>
                            <p class="animate__animated animate__fadeInUp">Lorem ipsum dolor, sit amet consectetur
                                adipisicing elit. Nihil possimus recusandae illo, qui sed, ut officiis eligendi
                                perferendis, dolores alias magni dolor quia facilis consequuntur id est. Explicabo
                                consectetur quam quisquam quasi enim nihil tempora earum rem facilis nemo? Itaque
                                ducimus similique esse nemo quibusdam sunt maxime aperiam ullam est!</p>
            ...
            <div class="container">
                ...
                <div class="row">
                    <div class="accordion accordion-flush" id="accordionFlushExample">
                        <?php foreach ($getAllLayanan as $layanan) : ?>
