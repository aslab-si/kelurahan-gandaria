    ...
    <div class="page-wrapper" id="main-wrapper" data-layout="vertical" data-navbarbg="skin6" data-sidebartype="full" data-sidebar-position="fixed" data-header-position="fixed">
        ...
        <div class="body-wrapper">
            ...
            <div class="container-fluid">
                <div class="card">
                    <div class="card-body">
                        <h5 class="card-title fw-semibold mb-4 text-center">Tambah Layanan</h5>
                        <form action="process/functionLayanan.php" method="post" class="px-2">
                            <div class="mb-3">
                            ...
                            <div class="mb-3 text-end">
                                <button type="submit" name="tambahLayanan" class="btn btn-primary">Submit</button>
